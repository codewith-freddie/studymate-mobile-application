                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(QuizActivity.this, "Score saved to leaderboard!", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(QuizActivity.this, "Error saving score to leaderboard.", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
