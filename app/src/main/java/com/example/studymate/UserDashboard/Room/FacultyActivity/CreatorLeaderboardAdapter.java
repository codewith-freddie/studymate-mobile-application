...
public class CreatorLeaderboardAdapter extends RecyclerView.Adapter<CreatorLeaderboardAdapter.ViewHolder> {

    private List<UserScore> userScoreList;

    public CreatorLeaderboardAdapter(List<UserScore> userScoreList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Bind data to views
        holder.tvLeaderboardRank.setText(String.valueOf(position + 1));
        ...
        // Load profile image using Glide (make sure to add Glide dependency in your build.gradle)
